...
This document contains release notes for the changes in each release of Montplex Serverless Cache, up through August 18, 2023.

## August 18, 2023

### Functionality Added or Changed

- Implemented auto fail over.
- Added support for the Enterprise BYOC (Bring Your Own Cloud) option.
- Improved Redis compatibility.
